# TODO: remove after https://github.com/conan-io/conan-center-index/pull/17282 has been merged
...
class ThrustConan(ConanFile):
    ...
    def requirements(self):
        # Use CUB from Conan, since the version included with CUDA is not guaranteed to be compatible
        self.requires("cub/1.17.2@cupoch")
